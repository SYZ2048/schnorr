...
def supplicant(a):
    ...
    "\tr = " + str(r)
    print
    "*  Getting point X on the elliptic curve."
...
def main():
    ...
    #     a = int(sys.argv[2])
    #     print
    #     "*  Alice Mode Activated (Supplicant Mode)"
    #     print
    #     "*  a = " + str(a)
    #     supplicant(a)
    #
    ...
    #     # call authenticator()
    #     print
    #     "*  Bob Mode Activated (Authenticator Mode)"
    #     print
    #     "*  This will be the public key used in the authentication:"
    #     vx = int(sys.argv[2])
    #     vy = int(sys.argv[3])
    #     v = ecc.ECPoint(vx, vy)
    #     print
    ...
    #         ("--authenticator" in sys.argv) or ("-a" in sys.argv))) or (
    #         (("--supplicant" in sys.argv) or ("-s" in sys.argv)) and (
    #         ("--authenticator" in sys.argv) or ("-a" in sys.argv))):
    #     #
    #     print
    #     usage
    #     print
