...
def main():
    p1 = ECPoint(int("188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF1012", 16),
                 int("07192B95FFC8DA78631011ED6B24CDD573F977A11E794811", 16))
    print
    hex(p1.doublePoint().x)
    print
    hex(p1.doublePoint().y)
    p2 = p1.doublePoint()
    p3 = p2.sum(p1)
    ...
    "3*p1"
    print
    hex(p1.multiplyPointByScalar(3).x)
    print
    hex(p1.multiplyPointByScalar(3).y)
    ...
    "4*p1"
    print
    hex(p1.multiplyPointByScalar(4).x)
    print
    hex(p1.multiplyPointByScalar(4).y)

    print
    "5*p1"
    print
    hex(p1.multiplyPointByScalar(5).x)
    print
    hex(p1.multiplyPointByScalar(5).y)

    print
    "6*p1"
    print
    hex(p1.multiplyPointByScalar(6).x)
    print
    hex(p1.multiplyPointByScalar(6).y)

    print
    "7*p1"
    print
    hex(p1.multiplyPointByScalar(7).x)
    print
    hex(p1.multiplyPointByScalar(7).y)
